...
#define TSDB_CODE_MND_MOUNT_NOT_EXIST           TAOS_DEF_ERROR_CODE(0, 0x0430)
#define TSDB_CODE_MND_MOUNT_NAME_ALREADY_EXIST  TAOS_DEF_ERROR_CODE(0, 0x0431)
#define TSDB_CODE_MND_MOUNT_PATH_ALREADY_EXIST  TAOS_DEF_ERROR_CODE(0, 0x0432)
#define TSDB_CODE_MND_INVALID_MOUNT_NAME        TAOS_DEF_ERROR_CODE(0, 0x0433)
#define TSDB_CODE_MND_INVALID_MOUNT_NAME_LINE   TAOS_DEF_ERROR_CODE(0, 0x0434)
#define TSDB_CODE_MND_INVALID_MOUNT_PATH        TAOS_DEF_ERROR_CODE(0, 0x0435)
#define TSDB_CODE_MND_MOUNT_SAME_CULSTER        TAOS_DEF_ERROR_CODE(0, 0x0436)
#define TSDB_CODE_MND_MOUNT_DB_NOT_EXIST        TAOS_DEF_ERROR_CODE(0, 0x0437)
#define TSDB_CODE_MND_MOUNT_TOO_MANY_DB         TAOS_DEF_ERROR_CODE(0, 0x0438)
#define TSDB_CODE_MND_MOUNT_INVALID_DB_NAME     TAOS_DEF_ERROR_CODE(0, 0x0439)
#define TSDB_CODE_MND_MOUNT_INVALID_REPLICA     TAOS_DEF_ERROR_CODE(0, 0x043A)
#define TSDB_CODE_MND_MOUNT_BEING_OPENED        TAOS_DEF_ERROR_CODE(0, 0x043B)
...
#define TSDB_CODE_PAR_MOUNT_NAME_TOO_LONG       TAOS_DEF_ERROR_CODE(0, 0x2680) 
#define TSDB_CODE_PAR_MOUNT_PATH_TOO_LONG       TAOS_DEF_ERROR_CODE(0, 0x2681) 
#define TSDB_CODE_PAR_MOUNT_PATH_EMPTY          TAOS_DEF_ERROR_CODE(0, 0x2682) 
