...
#define TSDB_CODE_MND_MOUNT_ALREADY_EXIST       TAOS_DEF_ERROR_CODE(0, 0x0431)
#define TSDB_CODE_MND_INVALID_MOUNT_NAME        TAOS_DEF_ERROR_CODE(0, 0x0432)
#define TSDB_CODE_MND_INVALID_MOUNT_PATH        TAOS_DEF_ERROR_CODE(0, 0x0433)
#define TSDB_CODE_MND_MOUNT_SAME_CULSTER        TAOS_DEF_ERROR_CODE(0, 0x0434)
#define TSDB_CODE_MND_MOUNT_DB_NOT_EXIST        TAOS_DEF_ERROR_CODE(0, 0x0435)
#define TSDB_CODE_MND_MOUNT_INVALID_REPLICA     TAOS_DEF_ERROR_CODE(0, 0x0436)
