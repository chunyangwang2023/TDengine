...
#define TSDB_CODE_MND_INVALID_MOUNT_PATH        TAOS_DEF_ERROR_CODE(0, 0x0434)
#define TSDB_CODE_MND_MOUNT_SAME_CULSTER        TAOS_DEF_ERROR_CODE(0, 0x0435)
#define TSDB_CODE_MND_MOUNT_DB_NOT_EXIST        TAOS_DEF_ERROR_CODE(0, 0x0436)
#define TSDB_CODE_MND_MOUNT_TOO_MANY_DB         TAOS_DEF_ERROR_CODE(0, 0x0437)
#define TSDB_CODE_MND_MOUNT_INVALID_DB_NAME     TAOS_DEF_ERROR_CODE(0, 0x0438)
#define TSDB_CODE_MND_MOUNT_INVALID_REPLICA     TAOS_DEF_ERROR_CODE(0, 0x0439)
