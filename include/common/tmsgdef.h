...
enum {
  ...
  TD_DEF_MSG_TYPE(TDMT_DND_UNMOUNT_VNODE, "unmount-vnode", NULL, NULL)
  TD_DEF_MSG_TYPE(TDMT_DND_GET_MOUNT_INFO, "get-mount-info", NULL, NULL) 
  TD_DEF_MSG_TYPE(TDMT_DND_SET_MOUNT_INFO, "set-mount-info", NULL, NULL) 
