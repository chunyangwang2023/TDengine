...
#define UNSUPPORT_TYPE(type)            \
  ...
  SUPPORT_TYPE(QUERY_NODE_TEMP_TABLE);
  SUPPORT_TYPE(QUERY_NODE_JOIN_TABLE);
  ...
  SUPPORT_TYPE(QUERY_NODE_EXPLAIN_OPTIONS);
  SUPPORT_TYPE(QUERY_NODE_STREAM_OPTIONS);
  ...
  SUPPORT_TYPE(QUERY_NODE_TRIM_DATABASE_STMT);
  ...
  SUPPORT_TYPE(QUERY_NODE_ALTER_LOCAL_STMT);
  SUPPORT_TYPE(QUERY_NODE_EXPLAIN_STMT);
  SUPPORT_TYPE(QUERY_NODE_DESCRIBE_STMT);
  SUPPORT_TYPE(QUERY_NODE_RESET_QUERY_CACHE_STMT);
  ...
  SUPPORT_TYPE(QUERY_NODE_CREATE_STREAM_STMT);
  SUPPORT_TYPE(QUERY_NODE_DROP_STREAM_STMT);
  ...
  SUPPORT_TYPE(QUERY_NODE_SHOW_STREAMS_STMT);
  ...
  SUPPORT_TYPE(QUERY_NODE_SHOW_APPS_STMT);
  SUPPORT_TYPE(QUERY_NODE_SHOW_VARIABLES_STMT);
  SUPPORT_TYPE(QUERY_NODE_SHOW_DNODE_VARIABLES_STMT);
  ...
  SUPPORT_TYPE(QUERY_NODE_LOGIC_PLAN_JOIN);
  ...
  SUPPORT_TYPE(QUERY_NODE_LOGIC_PLAN_WINDOW);
  SUPPORT_TYPE(QUERY_NODE_LOGIC_PLAN_FILL);
  SUPPORT_TYPE(QUERY_NODE_LOGIC_PLAN_SORT);
  SUPPORT_TYPE(QUERY_NODE_LOGIC_PLAN_PARTITION);
  ...
  SUPPORT_TYPE(QUERY_NODE_PHYSICAL_PLAN_STREAM_SCAN);
  ...
  SUPPORT_TYPE(QUERY_NODE_PHYSICAL_PLAN_MERGE_JOIN);
  ...
  SUPPORT_TYPE(QUERY_NODE_PHYSICAL_PLAN_GROUP_SORT);
  SUPPORT_TYPE(QUERY_NODE_PHYSICAL_PLAN_HASH_INTERVAL);
  SUPPORT_TYPE(QUERY_NODE_PHYSICAL_PLAN_MERGE_INTERVAL);
  SUPPORT_TYPE(QUERY_NODE_PHYSICAL_PLAN_MERGE_ALIGNED_INTERVAL);
  SUPPORT_TYPE(QUERY_NODE_PHYSICAL_PLAN_STREAM_INTERVAL);
  SUPPORT_TYPE(QUERY_NODE_PHYSICAL_PLAN_STREAM_FINAL_INTERVAL);
  SUPPORT_TYPE(QUERY_NODE_PHYSICAL_PLAN_STREAM_SEMI_INTERVAL);
  SUPPORT_TYPE(QUERY_NODE_PHYSICAL_PLAN_FILL);
  SUPPORT_TYPE(QUERY_NODE_PHYSICAL_PLAN_STREAM_FILL);
  SUPPORT_TYPE(QUERY_NODE_PHYSICAL_PLAN_MERGE_SESSION);
  SUPPORT_TYPE(QUERY_NODE_PHYSICAL_PLAN_STREAM_SESSION);
  SUPPORT_TYPE(QUERY_NODE_PHYSICAL_PLAN_STREAM_SEMI_SESSION);
  SUPPORT_TYPE(QUERY_NODE_PHYSICAL_PLAN_STREAM_FINAL_SESSION);
  SUPPORT_TYPE(QUERY_NODE_PHYSICAL_PLAN_MERGE_STATE);
  SUPPORT_TYPE(QUERY_NODE_PHYSICAL_PLAN_STREAM_STATE);
  SUPPORT_TYPE(QUERY_NODE_PHYSICAL_PLAN_PARTITION);
  SUPPORT_TYPE(QUERY_NODE_PHYSICAL_PLAN_STREAM_PARTITION);
  ...
  SUPPORT_TYPE(QUERY_NODE_PHYSICAL_PLAN_MERGE_EVENT);
  SUPPORT_TYPE(QUERY_NODE_PHYSICAL_PLAN_STREAM_EVENT);
...
int32_t mcCheckDbTable(const char *db, const char *table) {
  ...
  if (strcasecmp(db, TSDB_INFORMATION_SCHEMA_DB) == 0) {
    if (strcasecmp(table, TSDB_INS_TABLE_DNODES) == 0 || strcasecmp(table, TSDB_INS_TABLE_MNODES) == 0 ||
        ...
        strcasecmp(table, TSDB_INS_TABLE_CONFIGS) == 0 ||
